...
happyParse :: FAST_INT -> [HappyInput] -> HappyIdentity HappyAbsSynType
...
happyDoAction :: Input HappyAbsSynType-> Token
...
#if defined(HAPPY_INCR)
happyGoto :: FAST_INT -> Input HappyAbsSynType -> Token -> FAST_INT
