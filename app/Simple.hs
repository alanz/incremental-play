...
happyActOffsets = HappyA# "\x04\x00\x04\x00\x02\x00\xfe\xff\x00\x00\x00\x00"#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# "\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"#

happyDefActions :: HappyAddr
happyDefActions = HappyA# "\x00\x00\x00\x00\x00\x00\x00\x00\xfe\xff"#

happyCheck :: HappyAddr
happyCheck = HappyA# "\xff\xff\x00\x00\x04\x00\xff\xff\x02\x00\x01\x00\xff\xff\xff\xff\xff\xff"#

happyTable :: HappyAddr
happyTable = HappyA# "\x00\x00\x03\x00\xff\xff\x00\x00\x05\x00\x03\x00\x00\x00\x00\x00\x00\x00"#
...
{-# LINE 67 "happy-templates/GenericTemplate.hs" #-}
...
{-# LINE 203 "happy-templates/GenericTemplate.hs" #-}

-----------------------------------------------------------------------------
-- HappyState data type (not arrays)

{-# LINE 218 "happy-templates/GenericTemplate.hs" #-}
