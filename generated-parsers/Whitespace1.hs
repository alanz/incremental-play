...
data HappyAbsSyn t4 t5 t6 t7 t8 t9 t13 t14 t15 t16 t17
...
happyExpList = HappyA# ""#

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","Ultraroot","bos","eos","tree","Root","A","Bs","BWs","B","C","ws_pair","conn__B__","listb__BWs__","conn_pair__B__","'a'","'b'","'B'","'d'","'D'","'c'","'WS'","%eof"]
        bit_start = st * 25
        bit_end = (st + 1) * 25
...
happyGotoValidArray = HappyA# ""#

{-# NOINLINE happyGotoValid #-}
happyGotoValid st nt = valid
  where bit_nr = nt + st * 18
        valid = readArrayBit happyGotoValidArray bit_nr

happyFragileStateArray :: HappyAddr
happyFragileStateArray = HappyA# "\x00\x00\x08\x0f\x00\x00"#
...
happyActOffsets = HappyA# "\x0f\x00\x44\x00\x16\x00\x2f\x00\x41\x00\x00\x00\xfa\xff\x00\x00\x1c\x00\x00\x00\x19\x00\x00\x00\x06\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\x00\x18\x00\x17\x00\x00\x00\x00\x00\x15\x00\x13\x00\x12\x00\x0a\x00\x00\x00"#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# "\x04\x00\x20\x00\x3d\x00\x00\x00\x3a\x00\x00\x00\x2b\x00\x00\x00\x2c\x00\x00\x00\x39\x00\x00\x00\x32\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x32\x00\x31\x00\x2a\x00\x00\x00\x00\x00\x25\x00\x21\x00\x1f\x00\xff\xff\x00\x00"#

happyDefActions :: HappyAddr
happyDefActions = HappyA# "\xfd\xff\x00\x00\xf8\xff\x00\x00\xfc\xff\xfb\xff\x00\x00\xf9\xff\xf0\xff\xe9\xff\xeb\xff\xf6\xff\xf7\xff\xea\xff\xf5\xff\xf4\xff\xf3\xff\xf2\xff\xfe\xff\xe8\xff\xe6\xff\xe7\xff\xfa\xff\xf1\xff\xee\xff\xef\xff\xec\xff\xed\xff"#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#


-- [(ActionEntry,0,-3,1,2,[(1,4),(2,3)]),(ActionEntry,1,0,0,1,[(2,3)]),(ActionEntry,2,-8,11,4,[(4,5),(5,6),(6,7),(15,8)]),(ActionEntry,3,0,0,1,[(22,-1)]),(ActionEntry,4,-4,0,1,[(3,19)]),(ActionEntry,5,-5,0,0,[]),(ActionEntry,6,0,12,10,[(7,9),(8,10),(9,11),(12,12),(13,13),(14,14),(16,15),(17,16),(18,17),(19,18)]),(ActionEntry,7,-7,0,0,[]),(ActionEntry,8,-16,10,2,[(10,23),(20,24)]),(ActionEntry,9,-23,0,0,[]),(ActionEntry,10,-21,10,2,[(11,21),(21,22)]),(ActionEntry,11,-10,0,0,[]),(ActionEntry,12,-9,11,9,[(8,10),(9,11),(12,12),(13,20),(14,14),(16,15),(17,16),(18,17),(19,18)]),(ActionEntry,13,-22,0,0,[]),(ActionEntry,14,-11,0,0,[]),(ActionEntry,15,-12,0,0,[]),(ActionEntry,16,-13,0,0,[]),(ActionEntry,17,-14,0,0,[]),(ActionEntry,18,-2,0,0,[]),(ActionEntry,19,-24,11,9,[(8,10),(9,11),(12,12),(13,20),(14,14),(16,15),(17,16),(18,17),(19,18)]),(ActionEntry,20,-26,10,2,[(11,27),(21,28)]),(ActionEntry,21,-25,10,2,[(11,25),(21,26)]),(ActionEntry,22,-6,0,0,[]),(ActionEntry,23,-15,0,0,[]),(ActionEntry,24,-18,10,2,[(11,27),(21,28)]),(ActionEntry,25,-17,10,2,[(11,25),(21,26)]),(ActionEntry,26,-20,10,2,[(11,27),(21,28)]),(ActionEntry,27,-19,10,2,[(11,25),(21,26)])]
...
happyReduction_8 fragile p1@(Node (Val {here = (HappyAbsSyn16  happy_var_1)}) _)
...
happyReduction_9 fragile p1@(Node (Val {here = (HappyAbsSyn15  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn11
		 (happy_var_1
	)) (Just 8) fragile [p1]
happyReduction_9 fragile _  = notHappyAtAll 

happyReduce_10 am fragile = happySpecReduce_1  am 8# (happyReduction_10 fragile)
happyReduction_10 fragile p1
	 =  mkNode (HappyAbsSyn12
		 (BL
	)) (Just 9) fragile [p1]

happyReduce_11 am fragile = happySpecReduce_1  am 8# (happyReduction_11 fragile)
happyReduction_11 fragile p1
	 =  mkNode (HappyAbsSyn12
		 (BU
	)) (Just 9) fragile [p1]

happyReduce_12 am fragile = happySpecReduce_1  am 8# (happyReduction_12 fragile)
...
happyReduce_14 am fragile = happySpecReduce_1  am 9# (happyReduction_14 fragile)
happyReduction_14 fragile p1
	 =  mkNode (HappyAbsSyn13
		 (()
	)) (Just 10) fragile [p1]

happyReduce_15 am fragile = happySpecReduce_0  am 9# (happyReduction_15 fragile)
happyReduction_15 fragile  =  mkNode (HappyAbsSyn13
		 (()
	)) (Just 10) fragile []

happyReduce_16 am fragile = happySpecReduce_2  am 10# (happyReduction_16 fragile)
happyReduction_16 fragile p2
	p1
	 =  mkNode (HappyAbsSyn14
		 (PairWW
	)) (Just 11) fragile [p1,p2]

happyReduce_17 am fragile = happySpecReduce_2  am 10# (happyReduction_17 fragile)
happyReduction_17 fragile p2@(Node (Val {here = (HappyAbsSyn14  happy_var_2)}) _)
...
happyReduce_18 am fragile = happySpecReduce_2  am 10# (happyReduction_18 fragile)
happyReduction_18 fragile p2@(Node (Val {here = (HappyTerminal happy_var_2)}) _)
	p1@(Node (Val {here = (HappyAbsSyn14  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn14
		 (PairPW happy_var_1 happy_var_2
	)) (Just 11) fragile [p1,p2]
happyReduction_18 fragile _ _  = notHappyAtAll 

happyReduce_19 am fragile = happySpecReduce_2  am 10# (happyReduction_19 fragile)
happyReduction_19 fragile p2@(Node (Val {here = (HappyAbsSyn14  happy_var_2)}) _)
	p1@(Node (Val {here = (HappyAbsSyn14  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn14
...
happyReduce_20 am fragile = happySpecReduce_1  am 11# (happyReduction_20 fragile)
happyReduction_20 fragile p1@(Node (Val {here = (HappyAbsSyn12  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn15
		 (Conn  happy_var_1
	)) (Just 12) fragile [p1]
happyReduction_20 fragile _  = notHappyAtAll 

happyReduce_21 am fragile = happySpecReduce_1  am 11# (happyReduction_21 fragile)
happyReduction_21 fragile p1@(Node (Val {here = (HappyAbsSyn17  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn15
		 (happy_var_1
	)) (Just 12) fragile [p1]
happyReduction_21 fragile _  = notHappyAtAll 

happyReduce_22 am fragile = happySpecReduce_1  am 12# (happyReduction_22 fragile)
happyReduction_22 fragile p1@(Node (Val {here = (HappyAbsSyn11  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn16
		 (BSingle happy_var_1
	)) (Just 13) fragile [p1]
happyReduction_22 fragile _  = notHappyAtAll 

happyReduce_23 am fragile = happySpecReduce_2  am 12# (happyReduction_23 fragile)
happyReduction_23 fragile p2@(Node (Val {here = (HappyAbsSyn16  happy_var_2)}) _)
	p1@(Node (Val {here = (HappyAbsSyn16  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn16
		 (BDouble happy_var_1 happy_var_2
	)) (Just 13) fragile [p1,p2]
happyReduction_23 fragile _ _  = notHappyAtAll 

happyReduce_24 am fragile = happySpecReduce_2  am 13# (happyReduction_24 fragile)
happyReduction_24 fragile p2
	p1@(Node (Val {here = (HappyAbsSyn12  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn17
		 (ConnW happy_var_1
	)) (Just 14) fragile [p1,p2]
happyReduction_24 fragile _ _  = notHappyAtAll 

happyReduce_25 am fragile = happySpecReduce_2  am 13# (happyReduction_25 fragile)
happyReduction_25 fragile p2@(Node (Val {here = (HappyAbsSyn14  happy_var_2)}) _)
	p1@(Node (Val {here = (HappyAbsSyn12  happy_var_1)}) _)
	 =  mkNode (HappyAbsSyn17
		 (ConnP happy_var_1 happy_var_2
	)) (Just 14) fragile [p1,p2]
happyReduction_25 fragile _ _  = notHappyAtAll 

happyNewToken verifying action sts stk [] =
	happyDoAction NotVerifying 22# (mkTokensNode [Tok 22# notHappyAtAll]) action sts stk []
...
happyNewToken verifying action sts stk (t:ts) =
	...
	case getTerminals t of {
	  ...
	  (Tok _ tk:tks) ->
	    case tk of {
		TokL { tokType = T TokenA  } -> cont 15# (setTerminals t (Tok 15# tk:tks)) ((setTerminals t tks):ts);
		TokL { tokType = T TokenBL } -> cont 16# (setTerminals t (Tok 16# tk:tks)) ((setTerminals t tks):ts);
		TokL { tokType = T TokenBU } -> cont 17# (setTerminals t (Tok 17# tk:tks)) ((setTerminals t tks):ts);
		TokL { tokType = T TokenBd } -> cont 18# (setTerminals t (Tok 18# tk:tks)) ((setTerminals t tks):ts);
		TokL { tokType = T TokenBD } -> cont 19# (setTerminals t (Tok 19# tk:tks)) ((setTerminals t tks):ts);
		TokL { tokType = T TokenC  } -> cont 20# (setTerminals t (Tok 20# tk:tks)) ((setTerminals t tks):ts);
		TokL { tokType = T WS      } -> cont 21# (setTerminals t (Tok 21# tk:tks)) ((setTerminals t tks):ts);
		_ -> happyError' ((t:ts), [])
		};
